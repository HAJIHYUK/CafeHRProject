...
<div style="display: flex; gap: 10px;">
    <img src="doc/images/급여계산기%20페이지.png" width="48%" alt="급여계산기 대시보드">
    <img src="doc/images/급여계산기%20페이지에서%20급여%20계산결과%20.png" width="48%" alt="급여 계산 결과">
</div>
*좌: 월별 급여 관리 대시보드 / 우: 기본급 + 주휴수당이 합산된 최종 급여 명세*
